...
public class EditClassroomController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Classroom cr = (Classroom) jaxbUnmarshaller.unmarshal(file);
        ...
        classroomNameTextfield.setText(classroom.getName());
        capacityTextfield.setText(Integer.toString(classroom.capacity));
        teachersComboBox.setPromptText(classroom.getTeacher());
        listItemsStudents.addAll(classroom.getStudents());
    ...
    private void submitClassroom(ActionEvent event) throws IOException {
        ...
        alert.setContentText("Classroom Modified!");
